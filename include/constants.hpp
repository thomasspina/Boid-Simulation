...
#define BOID_DEFAULT_RADIUS 15.f // Radius to create boid shape
#define BOID_DEFAULT_COLOR sf::Color::Green
#define BOID_DEFAULT_SPEED 100.f
#define BOID_DEFAULT_MAX_SPEED 100.f
#define BOID_DEFAULT_MIN_SPEED 100.f

#define BOID_DEFAULT_BOUNDARY_RADIUS (BOID_DEFAULT_RADIUS + 200.f)
